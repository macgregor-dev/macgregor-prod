...
.config(['$mdThemingProvider', '$mdIconProvider', function($mdThemingProvider, $mdIconProvider) {
    ...
    .icon("moveadd", "svg/moving.svg", 12 )
    
    .icon("checked", "svg/checked-blue.svg", 12 )
    
    .icon("cancel", "svg/cancel-yellow.svg", 12 )
    
    .icon("bulk-delete", "svg/bulk-delete.svg", 12 )
...
.run(['$rootScope', '$mdSidenav', '$location', '$routeParams', function($rootScope, $mdSidenav, $location, $routeParams) {
  ...
  $rootScope.headerTitle = "Macgregor - Brisbane, QLD";
