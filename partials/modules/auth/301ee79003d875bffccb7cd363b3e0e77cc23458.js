(function(){
  ...
  .factory("Auth", ["$firebaseAuth",
    function($firebaseAuth) {
      var ref = new Firebase("https://congmap-prod.firebaseio.com");
  ...
  .controller('authCtrl', [
    '$rootScope', '$scope', 'Auth', '$mdSidenav', '$location', '$mdBottomSheet', '$log', '$q', '$firebaseObject', '$firebaseArray','$routeParams', 'mapsService', function($rootScope, $scope, Auth, $mdSidenav, $location, $mdBottomSheet, $log, $q, $firebaseObject, $firebaseArray, $routeParams, mapsService) {
      ...
      $scope.isMaint = false;
      $scope.fbUsersUrl = "https://congmap-prod.firebaseio.com/users/";
      $scope.$routeParams = $routeParams;
      $scope.isResettingPwd = false;
      $scope.allowedEmails = ["brisbanemandarin2014@gmail.com", "shilo.banihit@gmail.com", "sjwwow@gmail.com", "happyjacky123@gmail.com", "lionxtreme20@gmail.com", "jaychang2017@gmail.com", "trevor.lau89@gmail.com"];
...
//      });
      ...
      $scope.loginUser = function() {
        ...
        if ($scope.allowedEmails.indexOf($scope.email) == -1) {
          $scope.isPending = false;
